...
namespace Service.BalanceHistory.Postgres.Migrations
{
    ...
    [Migration("20210702130746_CashInOutandFee")]
    partial class CashInOutandFee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.BalanceHistory.Postgres.Models.CashInOutHistoryEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("SequenceId", "WalletId", "Asset")
                        .IsUnique();

                    b.HasIndex("WalletId", "Asset", "SequenceId");

                    b.ToTable("cash_in_out_history");
                });
